...
//                this.hour = calendarDate.get(Calendar.HOUR)
//                this.minute = calendarDate.get(Calendar.MINUTE)
...
//        Log.d("sooqua blyat ebanaya", cal.toString())
        return calendar
    }
    ...
    private fun saveTask() {
        ...
        if (editText!!.text.isNotEmpty()) {
            ...
            if (task!!.scheduledDate == null && task!!.scheduledTime == null) {
                ...
                task!!.scheduledDate = initScheduledDate().getTimeInMillis()
